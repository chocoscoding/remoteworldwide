...
import { AlertTriangle, Check, Repeat2, SendHorizontal, X } from "lucide-react";
...
function buildExchange(answer: Pick<JdQaAnswer, "question" | "verdict" | "missing" | "tips">, keyBase: string): ChatEntry[] {
  return [
...
const JdqaClient: FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f6]">
      ...
      <main className="px-8 py-7 pb-14 max-w-[1240px] mx-auto">
        {!job ? (
          <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
            ...
            <StickerButton variant="primary" size="md" className="mt-3" onClick={() => setPickerOpen(true)}>
              Pick a job
            </StickerButton>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-[420px_1fr] gap-5 items-start">
            ...
            <DashCard className="p-6 lg:sticky lg:top-24">
              ...
              <p className="text-[10.5px] font-bold uppercase tracking-[0.08em] text-black/40 mb-2">Full description</p>
      ...
      <JobPickerDialog open={pickerOpen} onOpenChange={setPickerOpen} jobs={jobs} onPick={selectJob} onCreate={createJob} />
    </div>
  );
};
