      ...
      <div className="w-full flex items-center text-white flex-col z-10 relative item justify-between h-full mt-2">
        <div className="w-full h-full flex flex-col items-center gap-1">
          ...
          <p className="text-lg w-[90%] max-w-[500px] text-center font-thin">
            Hoob is the platform, startups can get assistance with their recruitment of talent as well as connection with investors.
          </p>
          <button className="bg-white text-primary px-5 py-4 mt-6">Explore Jobs</button>
        </div>

        <div className="w-full mt-5">
          <hr className="w-full border-white/50 justify-self-end mb-2" />
          <div className="flex w-full justify-between flex-wrap text-white/60">
