        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="./categories">
              <p className="text-gray-700 hover:text-gray-900">Categories</p>
            </Link>
            <Link href="./blogs">
              <p className="text-gray-700 hover:text-gray-900">Blogs</p>
            </Link>

            <button className="px-5 py-2 bg-black text-white font-bold">Create Job</button>
