...
const SplitButton: FC<SplitButtonProps> = ({ label, icon, onClick, items, className }) => {
  ...
  return (
    <div ref={wrapRef} className={cn("relative inline-flex", className)}>
      <div className="inline-flex items-stretch rounded-lg border-[1.5px] border-[#222325] bg-[#222325] text-white shadow-[2px_2px_0_0_#e1f073] transition-[transform,box-shadow] duration-100 ease-out hover:shadow-[2.5px_2.5px_0_0_#e1f073] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none">
