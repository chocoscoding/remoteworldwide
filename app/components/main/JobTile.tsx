...
const JobTile: FC<JobTileType> = (props) => {
  ...
  return (
    <div className="flex p-4 mb-5 rounded-md gap-2 md:gap-3 shadow-sm transition-all duration-500 hover:scale-105 ease-in bg-white border border-gray-200 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      {/* logo
    main info */}
      <div className="flex flex-col md:flex-row flex-1 gap-2 md:gap-3">
        <div className="flex justify-between w-full md:w-fit items-center md:items-start">
          <div className="border-2 rounded-full p-1 w-fit h-fit aspect-square object-center flex-shrink-0 flex justify-center items-center">
            <Image loading="lazy" src={company.logo} alt="logo" width={40} height={40} className="rounded-full flex-shrink-0" />
          </div>
